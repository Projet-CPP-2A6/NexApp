...
<div class="menu">
    ...
    <?php
        // Check if the Image_Path is set and not empty
        if (isset($result['Image_Path']) && !empty($result['Image_Path'])) {
            echo '<p><strong></strong> <img src="' . $result['Image_Path'] . '" alt="Association Image"></p>';
        }
    ?>
    <div class="actions">
