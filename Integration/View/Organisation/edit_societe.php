...
<div class="menu">
    ...
    <div class="container">
        ...
        <form action="edit_societe.php?id=<?php echo $id; ?>" method="post" class="form" enctype="multipart/form-data">
    <label for="nom">Nom :</label>
    <input type="text" name="nom" id="nom" value="<?php echo $societeData['Nom_Soc']; ?>">
    <label for="matricule">Matricule :</label>
    <input type="text" name="matricule" id="matricule" value="<?php echo $societeData['matricule']; ?>">
    <label for="description">Description :</label>
    <textarea name="description" id="description" rows="4" cols="50"><?php echo $societeData['Desc_Soc']; ?></textarea>
    <label for="imageSociete">Nouvelle Image :</label>
    <input type="file" name="newImageSociete" id="newImageSociete">
