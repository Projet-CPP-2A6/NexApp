...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="flex">
         <p class="price">TND </i> <?= $fetch_cart['price']; ?></p>
      ...
      <p class="sub-total">sub total : <span>TND </i> <?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span></p>
   ...
   <?php if($grand_total != 0){ ?>
      <div class="cart-total">
         <p>grand total : <span>TND </i> <?= $grand_total; ?></span></p>
