<?php
 ...
 try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_nom_categorie'])) {
        ...
        // Use DELETE statement to remove rows with specific nom_categorie
        $deleteStatement = $conn->prepare('DELETE FROM categories WHERE nom_categorie = :delete_nom_categorie');
