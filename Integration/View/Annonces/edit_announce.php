...
require_once __DIR__ . '/../../Controller/EditAnnounceController.php';

$conn = Config::getConnexion();
$editAnnounceController = new EditAnnounceController($conn);
$editAnnounceController->handleAnnounceUpdate();
