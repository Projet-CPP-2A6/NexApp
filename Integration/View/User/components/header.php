...
<head>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css">
    ...
    <link rel="stylesheet" href="../User/accueil.css">
    <link rel="stylesheet" href="../User/actions.css">
    <link rel="stylesheet" href="../User/Boutique.css">
...
<br>
   <section class="flex">
      ...
      <nav class="navbar">
         ...
         <a href="index.php" class="btn btn-secondary">Index User</a>
         <a href="create.php" class="btn btn-secondary">Ajouter User</a>
