...
int mailer::sendEmail(QString email_emp, QString obj, QString bdy) {

    qDebug() << "sslLibraryBuildVersionString: "
             << QSslSocket::sslLibraryBuildVersionString();
    qDebug() << "sslLibraryVersionNumber: "
    ...
    QString username = "benhalimanur@gmail.com";
    QString password = "rstl vaag holr sbpy";
    // rstl vaag holr sbpy
    //  Sender and recipient information
    QString from = "benhalimanur@gmail.com";
    QString to = email_emp;
    QString subject = obj;
    QString body = bdy;
